...
public class KerAttrTb extends TableImpl<KerAttrTbRecord> {
    ...
    private static final long serialVersionUID = -650333303;
...
- for free attributes, if free attribute is marked as read-only, user cannot change its value directly, it is only possible to change it using PG version of mp_Set with p_ChangeReadOnly=TRUE. It can be used for attributes which are replicated from other system or set through CP interface of some entity
     ...
     */
    public final TableField<KerAttrTbRecord, String> GENMIGR = createField("GENMIGR", org.jooq.impl.SQLDataType.CHAR(1).defaultValue(org.jooq.impl.DSL.field("'N'\n", org.jooq.impl.SQLDataType.CHAR)), this, "Used for generator of migration framework");

    /**
     * The column <code>KER.KER_ATTR_TB.EVALCVALUE</code>.
     */
    public final TableField<KerAttrTbRecord, String> EVALCVALUE = createField("EVALCVALUE", org.jooq.impl.SQLDataType.CHAR(1).defaultValue(org.jooq.impl.DSL.field("NULL\n  ", org.jooq.impl.SQLDataType.CHAR)), this, "");
    ...
    public com.provys.catalogue.dbloader.db.tables.KerAttrTb kerAttrAccdocobjectformulFk() {
        return new com.provys.catalogue.dbloader.db.tables.KerAttrTb(this, Keys.KER_ATTR_ACCDOCOBJECTFORMUL_FK);
    }

    public com.provys.catalogue.dbloader.db.tables.KerAttrTb kerAttrOwnerformulaFk() {
        return new com.provys.catalogue.dbloader.db.tables.KerAttrTb(this, Keys.KER_ATTR_OWNERFORMULA_FK);
    }

    public com.provys.catalogue.dbloader.db.tables.KerAttrTb kerAttrFromobjectformulaFk() {
        return new com.provys.catalogue.dbloader.db.tables.KerAttrTb(this, Keys.KER_ATTR_FROMOBJECTFORMULA_FK);
    }

    public com.provys.catalogue.dbloader.db.tables.KerAttrTb kerAttrToobjectformulaFk() {
        return new com.provys.catalogue.dbloader.db.tables.KerAttrTb(this, Keys.KER_ATTR_TOOBJECTFORMULA_FK);
    }

    public com.provys.catalogue.dbloader.db.tables.KerAttrTb kerAttrTextsrcFk() {
        return new com.provys.catalogue.dbloader.db.tables.KerAttrTb(this, Keys.KER_ATTR_TEXTSRC_FK);
    }

    public com.provys.catalogue.dbloader.db.tables.KerAttrTb kerAttrImgsrcFk() {
        return new com.provys.catalogue.dbloader.db.tables.KerAttrTb(this, Keys.KER_ATTR_IMGSRC_FK);
    }
