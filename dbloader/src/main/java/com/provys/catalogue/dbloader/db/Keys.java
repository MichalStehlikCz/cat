...
import com.provys.catalogue.dbloader.db.tables.records.KerRelTbRecord;
...
public class Keys {
    ...
    public static final UniqueKey<KerEntitygrpTbRecord> KER_ENTITYGRP_PK = UniqueKeys0.KER_ENTITYGRP_PK;
    public static final UniqueKey<KerEntitygrpTbRecord> KER_ENTITYGRP_UPNAME_UK = UniqueKeys0.KER_ENTITYGRP_UPNAME_UK;
    public static final UniqueKey<KerEntitygrpTbRecord> KER_ENTITYGRP_NM_UK = UniqueKeys0.KER_ENTITYGRP_NM_UK;
    ...
    public static final ForeignKey<KerEntitygrpTbRecord, KerEntitygrpTbRecord> KER_ENTITYGRP_PARENT_FK = ForeignKeys0.KER_ENTITYGRP_PARENT_FK;
    ...
    public static final ForeignKey<KerEntityTbRecord, KerEntitygrpTbRecord> KER_ENTITY_ENTITYGRP_FK = ForeignKeys0.KER_ENTITY_ENTITYGRP_FK;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<KerEntitygrpTbRecord> KER_ENTITYGRP_PK = Internal.createUniqueKey(KerEntitygrpTb.KER_ENTITYGRP_TB, "KER_ENTITYGRP_PK", KerEntitygrpTb.KER_ENTITYGRP_TB.ENTITYGRP_ID);
        public static final UniqueKey<KerEntitygrpTbRecord> KER_ENTITYGRP_UPNAME_UK = Internal.createUniqueKey(KerEntitygrpTb.KER_ENTITYGRP_TB, "KER_ENTITYGRP_UPNAME_UK", KerEntitygrpTb.KER_ENTITYGRP_TB.X_UPNAME, KerEntitygrpTb.KER_ENTITYGRP_TB.PARENT_ID);
        public static final UniqueKey<KerEntitygrpTbRecord> KER_ENTITYGRP_NM_UK = Internal.createUniqueKey(KerEntitygrpTb.KER_ENTITYGRP_TB, "KER_ENTITYGRP_NM_UK", KerEntitygrpTb.KER_ENTITYGRP_TB.NAME_NM);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<KerAttrTbRecord, KerAttrTbRecord> KER_ATTR_FROMOBJECTFORMULA_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ATTR_PK, KerAttrTb.KER_ATTR_TB, "KER_ATTR_FROMOBJECTFORMULA_FK", KerAttrTb.KER_ATTR_TB.FROMOBJECTFORMULA_ID);
        public static final ForeignKey<KerAttrTbRecord, KerAttrTbRecord> KER_ATTR_TOOBJECTFORMULA_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ATTR_PK, KerAttrTb.KER_ATTR_TB, "KER_ATTR_TOOBJECTFORMULA_FK", KerAttrTb.KER_ATTR_TB.TOOBJECTFORMULA_ID);
        public static final ForeignKey<KerAttrTbRecord, KerAttrTbRecord> KER_ATTR_TEXTSRC_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ATTR_PK, KerAttrTb.KER_ATTR_TB, "KER_ATTR_TEXTSRC_FK", KerAttrTb.KER_ATTR_TB.TEXTSRC_ID);
        public static final ForeignKey<KerAttrTbRecord, KerAttrTbRecord> KER_ATTR_IMGSRC_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ATTR_PK, KerAttrTb.KER_ATTR_TB, "KER_ATTR_IMGSRC_FK", KerAttrTb.KER_ATTR_TB.IMGSRC_ID);
        public static final ForeignKey<KerEntitygrpTbRecord, KerEntitygrpTbRecord> KER_ENTITYGRP_PARENT_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ENTITYGRP_PK, KerEntitygrpTb.KER_ENTITYGRP_TB, "KER_ENTITYGRP_PARENT_FK", KerEntitygrpTb.KER_ENTITYGRP_TB.PARENT_ID);
        public static final ForeignKey<KerEntityTbRecord, KerEntityTbRecord> KER_ENTITY_ANCESTOR_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ENTITY_PK, KerEntityTb.KER_ENTITY_TB, "KER_ENTITY_ANCESTOR_FK", KerEntityTb.KER_ENTITY_TB.ANCESTOR_ID);
        public static final ForeignKey<KerEntityTbRecord, KerRelTbRecord> KER_ENTITY_MASTER_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_REL_PK, KerEntityTb.KER_ENTITY_TB, "KER_ENTITY_MASTER_FK", KerEntityTb.KER_ENTITY_TB.MASTER_ID);
        public static final ForeignKey<KerEntityTbRecord, KerEntitygrpTbRecord> KER_ENTITY_ENTITYGRP_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ENTITYGRP_PK, KerEntityTb.KER_ENTITY_TB, "KER_ENTITY_ENTITYGRP_FK", KerEntityTb.KER_ENTITY_TB.ENTITYGRP_ID);
        public static final ForeignKey<KerRelTbRecord, KerEntityTbRecord> KER_REL_ENTITY_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ENTITY_PK, KerRelTb.KER_REL_TB, "KER_REL_ENTITY_FK", KerRelTb.KER_REL_TB.ENTITY_ID);
        public static final ForeignKey<KerRelTbRecord, KerEntityTbRecord> KER_REL_TOENTITY_FK = Internal.createForeignKey(com.provys.catalogue.dbloader.db.Keys.KER_ENTITY_PK, KerRelTb.KER_REL_TB, "KER_REL_TOENTITY_FK", KerRelTb.KER_REL_TB.TOENTITY_ID);
    }
}
