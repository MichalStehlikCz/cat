...
M - manually processed - import procedure doesn't exist, still these items are transferred during upgrades
    ...
    /**
     * The column <code>KER.KER_ENTITY_TB.X_HASDELROWFLAGDEF</code>. Existence of flagdef for given entity with DELETEROW='Y', which is handled during object delete operation
     */
    ...
    public List<ForeignKey<KerEntityTbRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<KerEntityTbRecord, ?>>asList(Keys.KER_ENTITY_ANCESTOR_FK, Keys.KER_ENTITY_MASTER_FK, Keys.KER_ENTITY_ENTITYGRP_FK);
    }

    public com.provys.catalogue.dbloader.db.tables.KerEntityTb kerEntityTb() {
        return new com.provys.catalogue.dbloader.db.tables.KerEntityTb(this, Keys.KER_ENTITY_ANCESTOR_FK);
    }
    ...
    public KerEntitygrpTb kerEntitygrpTb() {
        return new KerEntitygrpTb(this, Keys.KER_ENTITY_ENTITYGRP_FK);
    }
